...
<body>
    ...
    <form class="form_container" method="GET" action="userLogin.php">
        ...
        <button title="Sign In" type="submit" class="sign-in_btn" id="login_btn">
            <span>Sign In</span>
        </button>
        <p class="signin">No acount ? <a href="resistration.php">Sign Up</a> </p>
